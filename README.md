...
<font face="Times New Roman"> Most previous PGMs were only suitable for a single-language, mostly English. As of September 2020, Chinese netizens accounted for 20\% of the world's Internet netizens. Thus, we give constructions of JoyMem in both Chinese and English, and release the corresponding materials. JoyMem is customizable and can be extended to different languages and application scenarios. We also analyze the memorability and security of the generated passwords from both theoretical estimation and experimental testing, and compare JoyMem with leading PGMs, such as Surpass, Optiwords and MneGenEx/MnePerEx.</font>
